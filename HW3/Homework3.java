...
public class Homework3 {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(result + " The size field is " + list5.length() + ".");
        ...
        System.out.println(result + " The size field is " + list6.length() + ".");
        TestHelper.verify(result.equals("[  6  3  6  3  6  3  ]"),
                "BAD SQUISH!!!  No biscuit.");
        TestHelper.verify(list6.length() == 6, "BAD SIZE!!! GO UPDATE THE SIZE!");
        ...
        System.out.println(result + " The size field is " + list7.length() + ".");
        ...
        System.out.println(result + " The size field is " + list8.length() + ".");
        TestHelper.verify(result.equals("[  0  1  2  3  4  5  6  ]"),
                "BAD SQUISH!!!  No biscuit.");
        ...
        System.out.println(result + " The size field is " + list9.length() + ".");
        TestHelper.verify(result.equals("[  ]"),
                "BAD SQUISH!!!  No biscuit.");
